...
Installation:
1) Insert folder "bzzz_chickenfire" to resources folder
2) Add to server.cfg
3) Restart server
...
Add this line:
data_file 'DLC_ITYP_REQUEST' 'stream/bzzz_fire_chicken_a.ytyp'
...
Flag of the prop is set to 32 (static) without bone.