...
Installation:
1) Insert folder "bzzz_little_light" to resources folder
2) Add to server.cfg
3) Restart server
...
Add this line:
data_file 'DLC_ITYP_REQUEST' 'stream/bzzz_light_little_color_pack.ytyp'
...
Strong lights = multiple props in one location may cause the player to not connect in that location.