...
In some cases we recommend removing the entire map containing the duplicate file!
File name -  v_int_10.ytyp

---- BUGGED COLLISIONS ----
Check this file in your resources folder searching for duplicated files, when you find the duplicated delete it! 
In some cases we recommend removing the entire map containing the duplicate file!
File name -  v_genbank.ybn
File name -  hi@v_genbank.ybn


---- sp_manifest CRASH ----
Check this file in your resources folder searching for duplicated files, when you find the duplicated delete it! 
In some cases we recommend removing the entire map containing the duplicate file!
File name -  sp_manifest.ymt

Or

Remove the sp_manifest from the Fleeca folder and remove the code (about the sp_manifest) lines from the fxmanifest.lua 
